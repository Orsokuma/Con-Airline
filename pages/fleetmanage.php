...
function index() {
global $db,$userid,$orderby,$ads,$skipcost; 
...
$ir = $db->fetch_row($fet);
    ...
    if ($_GET['ord'] == 'id') { $st1='<b>'; $en1='</b>'; }
    if ($_GET['ord'] == 'planeUname') { $st2='<b>'; $en2='</b>'; }
    if ($_GET['ord'] == 'planeACTIVE') { $st3='<b>'; $en3='</b>'; }
    if ($_GET['ord'] == 'planeSPEED') { $st4='<b>'; $en4='</b>'; }
    if ($_GET['ord'] == 'planeMONEYMADE') { $st5='<b>'; $en5='</b>'; }
    if ($_GET['ord'] == 'planeDISTANCETRAVELLED') { $st6='<b>'; $en6='</b>'; }
    if ($_GET['ord'] == 'DESC') { $st7='<b>'; $en7='</b>'; }
    if ($_GET['ord'] == 'ASC') { $st8='<b>'; $en='</b>'; }
...
<ul class="nav bg-<?php echo $ir['theme']; ?> fixed-top">
    ...
    <li class="nav-item">
      <a class="btn btn-<?php echo $ir['theme']; ?>" href="?a=index&ord=id&u=<?php echo $userid; ?>" target="fleetmanage"><?php echo $st1; ?>PlaneID<?php echo $en1; ?></a>
    </li>
    <li class="nav-item">
      <a class="btn btn-<?php echo $ir['theme']; ?>" href="?a=index&ord=planeUname&u=<?php echo $userid; ?>" target="fleetmanage"><?php echo $st2; ?>Nickname<?php echo $en2; ?></a>
    </li>
    <li class="nav-item">
      <a class="btn btn-<?php echo $ir['theme']; ?>" href="?a=index&ord=planeACTIVE&u=<?php echo $userid; ?>" target="fleetmanage"><?php echo $st3; ?>Plane Active<?php echo $en3; ?></a>
    </li>
    <li class="nav-item">
      <a class="btn btn-<?php echo $ir['theme']; ?>" href="?a=index&ord=planeSPEED&u=<?php echo $userid; ?>" target="fleetmanage"><?php echo $st4; ?>Speed<?php echo $en4; ?></a>
    </li>
    <li class="nav-item">
      <a class="btn btn-<?php echo $ir['theme']; ?>" href="?a=index&ord=planeMONEYMADE&u=<?php echo $userid; ?>" target="fleetmanage"><?php echo $st5; ?>Money Made<?php echo $en5; ?></a>
    </li>
    <li class="nav-item">
      <a class="btn btn-<?php echo $ir['theme']; ?>" href="?a=index&ord=planeDISTANCETRAVELLED&u=<?php echo $userid; ?>" target="fleetmanage"><?php echo $st6; ?>Distance Travelled<?php echo $en6; ?></a>
    </li>
    <li class="nav-item">
      <a class="btn btn-<?php echo $ir['theme']; ?>">|</a>
    </li>
    <li class="nav-item">
      <a class="btn btn-<?php echo $ir['theme']; ?>" href="?a=index&ord=<?php echo $orderby; ?>&ads=DESC&u=<?php echo $userid; ?>" target="fleetmanage"><?php echo $st7; ?>Desc<?php echo $en7; ?></a>
    </li>
    <li class="nav-item">
      <a class="btn btn-<?php echo $ir['theme']; ?>" href="?a=index&ord=<?php echo $orderby; ?>&ads=ASC&u=<?php echo $userid; ?>" target="fleetmanage"><?php echo $st8; ?>Asc<?php echo $en8; ?></a>
    </li>
    <li class="nav-item">
        <a class="btn btn-<?php echo $ir['theme']; ?>">|</a>
    </li>
