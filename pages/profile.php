...
$userid = $_GET['u'];
        ...
        ?>
        	...
        	<table border='0' class='table'>
        	   <tr>
        	       <td colspan="2" align="center"><img src="<?php echo $ir['profileimage']; ?>" height="200px"></td>
        	   </tr>
        	   <tr>
        	        <td><b>Bucks:</b></td>
        	   ...
        	   <tr>
        	       <tr>
        	        ...
        	        <td><b><font color="<?php echo $ir['airlinecolour']; ?>"><?php echo $ir['airlinename']; ?></font></b></td>
        	   <tr>
        	   ...
        	   <tr>
        	   <tr>
        	       <td><b>Money Made from Flights:</b></td>
        	       <td><span class="bucks"><?php echo money_formatter($ir['totalmoney']); ?></span></td>
        	   </tr>
        	   <tr>
        	       <td><b>Total Distance Traveled:</b></td>
        	       <td><b><?php echo number_format($ir['totaldistance']); ?> km</b></td>
        	   </tr>
        	   <tr>
        	       <td><b>Join Date</b></td>
        	       <td><b><?php 
